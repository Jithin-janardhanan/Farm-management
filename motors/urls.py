...
from .views import (
    ...
    UserMotorListCreateView, UserMotorRetrieveUpdateDestroyView, UserValveListView, UserValveControlView,
    UserMotorStatusToggleView)
...
urlpatterns = [
    ...
    # Existing URLs...
    path('api/motors/', UserMotorListCreateView.as_view(), name='user-motor-list-create'),
    path('api/motors/<int:pk>/', UserMotorRetrieveUpdateDestroyView.as_view(), name='user-motor-detail'),
    path('api/motors/<int:motor_id>/valves/', UserValveListView.as_view(), name='user-motor-valves'),
    path('api/motors/<int:motor_id>/valves/<int:valve_number>/control/', UserValveControlView.as_view(), name='user-valve-control'),
    path('api/motors/<int:motor_id>/toggle-status/', UserMotorStatusToggleView.as_view(), name='user-motor-toggle-status'),
